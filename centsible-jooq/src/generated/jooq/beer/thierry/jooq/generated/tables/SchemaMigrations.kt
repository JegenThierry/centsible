...
import beer.thierry.jooq.generated.keys.SCHEMA_MIGRATIONS_PKEY
...
open class SchemaMigrations(
     ...
     */
    val VERSION: TableField<SchemaMigrationsRecord, String?> = createField(DSL.name("version"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.schema_migrations.executed_at</code>.
     */
    val EXECUTED_AT: TableField<SchemaMigrationsRecord, OffsetDateTime?> = createField(DSL.name("executed_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")
