...
data class Rules(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        else if (this.matchAll != o.matchAll)
            return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.matchAll == null) 0 else this.matchAll.hashCode())
