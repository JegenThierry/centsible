...
open class RecurringTransactions(
    ...
    override fun getChecks(): List<Check<RecurringTransactionsRecord>> = listOf(
        ...
        Internal.createCheck(this, DSL.name("recurring_transactions_frequency_check"), "(((frequency)::text = ANY ((ARRAY['DAILY'::character varying, 'WEEKLY'::character varying, 'BIWEEKLY'::character varying, 'MONTHLY'::character varying, 'YEARLY'::character varying])::text[])))", true)
    )
