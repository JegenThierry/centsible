...
import OnboardingAccountStep from "~/components/_organisms/onboarding/onboarding-account-step.vue";
import OnboardingCategoriesStep from "~/components/_organisms/onboarding/onboarding-categories-step.vue";
import OnboardingDoneStep from "~/components/_organisms/onboarding/onboarding-done-step.vue";
...
<template>
  <UContainer class="py-10 max-w-2xl">
    ...
    <UCard>
      <OnboardingAccountStep v-if="step === 1"
                             v-model:name="accountForm.name"
                             v-model:initial-balance="accountForm.initialBalance"
                             v-model:currency="accountForm.currency"
                             :loading="loading"
      ...
      <OnboardingCategoriesStep v-else-if="step === 2"
                                :expense-suggestions="expenseSuggestions"
                                :income-suggestions="incomeSuggestions"
