...
const i18nFiles = [
  ...
  'budgets.json', 'categories.json', 'contacts.json', 'profile.json', 'exports.json',
  'integrations.json', 'notifications.json', 'onboarding.json', 'reports.json', 'attachments.json',
  'admin.json',
];
